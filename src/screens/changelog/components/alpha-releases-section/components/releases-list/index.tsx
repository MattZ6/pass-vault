...
export function ReleasesList() {
  ...
  const alphaVersions = useMemo(() => {
    const rawVersionsMap = t("early", {
      returnObjects: true,
    }) as RawVersionMap;

    return Object.entries(rawVersionsMap).map(([tag, rawVersion]) => {
      return {
        tag,
        label: rawVersion.label,
